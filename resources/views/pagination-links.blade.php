...
<ul class="flex justify-between" style="list-style-type:none;cursor:pointer">
    <!-- prev -->
    @if ($paginator->onFirstPage())
    <li class="w-16 px-2 py-1 text-center rounded border bg-gray">Prev</li>
    @else
    ...
    <div class="flex">
        ...
        <li class="mx-2 w-10 px-2 py-1 text-center rounded border shadow bg-info text-white cursor-pointer" wire:click="gotoPage({{$page}})">{{$page}}</li>
        @else
